...
Butter::Butter(float posX, float posY, float posZ) : GameObject(posX, posY, posZ, 0 , BUTTERRADIUS, "Butter"){}


void Butter::update(double timePassed) {
...
void Butter::treatCollision(GameObject * obj) {
	if (obj->getName() == "Car") {
		this->setSpeed(0.05f * obj->getSpeed());
		this->setAceleration(-0.05f * obj->getAceleration());
